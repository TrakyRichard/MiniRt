...
/*   Updated: 2023/07/13 07:37:08 by richard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned char	*info_header_bmp(t_r resolution)
{
...
void	write_data(int f, const unsigned char *data, t_r resolution)
{
...
void	save_bmp(const char *filename, const unsigned char *data, const t_r resolution)
{
	int				filesize;
	int				f;
	unsigned char	*bmpfileheader;
